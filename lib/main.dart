...
class QuizScreen extends HookWidget {
            ...
            error: (error, _) =>
                QuizError(
                    message: error is Failure
                        ? error.message
                        : 'Something went wrong!', key: UniqueKey(),
                )
  ...
  Widget _buildBody(
    ...
    if (questions.isEmpty) return QuizError(message: 'No questions found.', key: UniqueKey(),);

    final quizState = useProvider(quizControllerProvider);
    return quizState.status == QuizStatus.complete
        ? QuizResults(state: quizState, questions: questions, key: UniqueKey(),)
        : QuizQuestions(
      pageController: pageController,
      state: quizState,
      questions: questions, key: UniqueKey(),
    );
  }
}
          ...
          children: [
            ...
            Column(
              children: question.answers
                  ...
                  onTap: () => context
                      .read(quizControllerProvider.notifier)
                      .submitAnswer(question, e), key: UniqueKey(),
                ),
              )
                  .toList(),
            ),
